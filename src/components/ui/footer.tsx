...
export function Footer() {
  ...
  return (
    <footer
      className={`relative z-50 transition-transform duration-500 ${visible ? "translate-y-0" : "translate-y-full"} bg-background/80 border-t border-border backdrop-blur-md`}
    >
